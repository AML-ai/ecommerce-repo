...
(function () {
        ...
        return {
            define: function (b, e) {
                ...
                if (0 > g.getListenerIndex(e)) {
                    ...
                    h.fn = e;
                    h.priority = d;
                    for (var p = g.length - 1; 0 <= p; p--) if (g[p].priority <= d) return g.splice(p + 1, 0, h), {removeListener: l};
                    g.unshift(h)
                }
    ...
    (CKEDITOR.editor = function () {
        ...
        var a = [], f = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, e = /</g, m = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
        ...
        var a = CKEDITOR.tools.extend, f = function (a, g) {
                ...
                table: 1,
                ul: 1
            }, m = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, d = {"#": 1},
        ...
        a(f, {
            $block: a({
                audio: 1, dd: 1, dt: 1, figcaption: 1,
                li: 1, video: 1
            }, e, h),
            $blockLimit: {
                article: 1,
            ...
            $intermediate: {
                caption: 1, colgroup: 1, dd: 1, dt: 1, figcaption: 1, legend: 1, li: 1, optgroup: 1, option: 1,
                rp: 1, rt: 1, summary: 1, tbody: 1, td: 1, tfoot: 1, th: 1, thead: 1, tr: 1
            }
        });
        return f
        ...
        var c = f.getCustomData("list_marker_names"), e = f.getCustomData("list_marker_id"), m;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype,
            {
                ...
                getTabIndex: function () {
                    ...
                    if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                        ...
                        var m = this.$.getBoundingClientRect(), k = g.$.documentElement,
                            w = k.clientTop || e.$.clientTop || 0, q = k.clientLeft || e.$.clientLeft || 0, x = !0;
                    ...
                    } else for (w = this, q = null; w && "body" != w.getName() &&
                    "html" != w.getName();) {
                    ...
                    f = a.getWindow();
                    e = w(this, f);
                    var r = w(a, f), A = this.$.offsetHeight;
                    g = this.$.offsetWidth;
                    var t = a.$.clientHeight, y = a.$.clientWidth;
        ...
        function a(a, b) {
            ...
            c = g.endContainer;
            var e = g.startOffset, f = g.endOffset, l, h = this.guard, n = this.type,
        ...
        function f(a, b, c, d, e) {
            ...
            a.optimizeBookmark();
            var m = 0 === b, k = 1 == b, t = 2 == b;
            b = t || k;
            var y = a.startContainer, v = a.endContainer, z = a.startOffset, B = a.endOffset, H, G, E, I, F, K;
            if (t && v.type == CKEDITOR.NODE_TEXT && (y.equals(v) || y.type === CKEDITOR.NODE_ELEMENT && y.getFirst().equals(v))) c.append(a.document.createText(v.substring(z, B))); else {
                ...
                L = c;
                for (O = Q; O <= R; O++) if (c = D[O], ba = c.getPrevious(), c.equals(J[O])) b && (L = L.getChild(0));
                else {
        ...
        function c(a) {
            var b =
                CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.dom.walker.bookmark(1);
            return function (d) {
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var l = this.getCommonAncestor(), h = this.root, m, k, t, y, v, z = !1, B, H;
                        ...
                        for (t = c(t); t || y;) {
                            ...
                            for (; y;) if (B = !1, y.type == CKEDITOR.NODE_COMMENT) y = y.getPrevious(); else {
                                if (y.type == CKEDITOR.NODE_TEXT) H = y.getText(), d.test(H) && (y = null), B = /[\s\ufeff]$/.test(H); else if ((y.$.offsetWidth > (CKEDITOR.env.webkit ? 1 :
                        ...
                        for (; t || y;) {
                            ...
                            for (; y;) {
                                ...
                                if (y.type == CKEDITOR.NODE_TEXT) H = y.getText(), f(y, 0) || (y = null), B = /^[\s\ufeff]/.test(H); else if (y.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < y.$.offsetWidth ||
                                        b && y.is("br")) && !y.data("cke-bookmark")) if (z && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                                        H = y.getText();
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            t = this.clone();
                            t = new CKEDITOR.dom.walker(t);
                            var N = CKEDITOR.dom.walker.whitespaces(), R = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var f = this.clone(), l =
                        this.startContainer, h = this.endContainer, m = this.startOffset, k = this.endOffset, t = c = 1;
                    ...
                    var f = new CKEDITOR.dom.walker(f), y = CKEDITOR.dom.walker.bookmark(),
                ...
                return {previousBlock: e, nextBlock: f, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: l}
                ...
                var c, d = 0, e, f, l = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], f, l, h, m;
                if (c && c.find) for (l = c.find(a), f = 0; f < l.count(); f++) if (c = l.getItem(f), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING ||
        ...
        CKEDITOR.dom.range.mergeRanges = function (a) {
            return CKEDITOR.tools.array.reduce(a, function (a, b) {
                ...
                if (c) {
                    var g = new CKEDITOR.dom.range(b.root), d = new CKEDITOR.dom.walker(g),
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    f = w.startPath();
                    var q = w.endPath(), x = !w.collapsed && c(w, f.block), r = !w.collapsed && c(w, q.block, 1);
                ...
                for (this._.nextNode = null; q;) {
                    var x = 0, r = q.hasAscendant("pre"), A = q.type != CKEDITOR.NODE_ELEMENT, t = 0;
                    if (A) q.type == CKEDITOR.NODE_TEXT && e.test(q.getText()) && (A = 0); else {
                        ...
                        if (CKEDITOR.dtd.$block[y] && "false" == q.getAttribute("contenteditable")) {
                            ...
                            b(this, a, g);
                            break
                        } else if (q.isBlockBoundary(this.forceBrBreak && !r && {br: 1})) {
                    ...
                    if (f && !x) for (; !q.getNext(d) && !k;) {
                        y =
                            q.getParent();
                        if (y.isBlockBoundary(this.forceBrBreak && !r && {br: 1})) {
                            x = 1;
                            A = 0;
                            k || y.equals(w);
        ...
        function a(a, b, c, d, e) {
            ...
            for (g in b) {
                ...
                for (m in K) {
                    h[m] = k(h[m],
                        l) || null;
                    var q = h, t = J[m], y = k(h[J[m]], l), D = h[m], v = [], H = !0, n = void 0;
                    y ? H = !1 : y = {};
        ...
        function u(a, b, d, e) {
            ...
            if (e.doFilter) {
                ...
                var J = a.validStyles;
                h = a.validClasses;
                var l = b.attributes, H = b.styles, m = b.classes;
                k = b.classBackup;
                var n = b.styleBackup, x, r, z = [], t = [], E = /^data-cke-/;
                D = !1;
                delete l.style;
                delete l["class"];
        ...
        function t(a, b, c) {
            ...
            if (G.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(r()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (G.$block[d] || "tr" == d) if ("br" == b) a.previous && !A(a.previous) && (b = r(), b.insertBefore(a)), a.next && !A(a.next) && (b = r(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = G[b];
        ...
        function v(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, g, f, h, l;
        ...
        var G = CKEDITOR.dtd, E = CKEDITOR.tools.copy, I = CKEDITOR.tools.trim, F = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                if ("string" == typeof b) b = g(b); else if (b instanceof CKEDITOR.style) {
                    ...
                    d = e.attributes;
                    b[e.element] = e = {
                        styles: e.styles, requiredStyles: e.styles &&
                ...
                var e = this, g = [], f = this.editor && this.editor.config.protectedSource, h, l = !1, m = {
                    doFilter: !c,
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a:{
                            ...
                            c = [];
                            var q, k, t;
                            if (f) for (k = 0; k < f.length; ++k) if ((t = d.match(f[k])) &&
                                t[0].length == d.length) {
                                c = !0;
                                break a
                            }
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var g = void 0, f = void 0, h = void 0, l = void 0, m = void 0, q = void 0;
                        c = [];
                        for (f = 0; f < b.length; ++f) h = b[f], "string" == typeof h ? (h = h.split(/\s*:\s*/), l = h[0], m = null, q = h[1]) : (l = h.check, m = h.left,
                            q = h.right), g || (g = h, g = g.element ? g.element : l ? l.match(/^([a-z0-9]+)/i)[0] : g.left.getDefinition().element), m instanceof CKEDITOR.style && (m = B(m)), c.push({
                            check: l == g ? null : l,
                            left: m,
                ...
                var h =
                    CKEDITOR.tools.clone(e), m = [], q;
                if (!1 !== b && (q = this._.transformations[e.name])) {
                    for (d = 0; d < q.length; ++d) y(this, e, q[d]);
                    w(e)
                }
                u(this, h, m, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
        ...
        var K = {styles: 1, attributes: 1, classes: 1},
            ...
            Q = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, N = /^cke:(object|embed|param)$/,
            R = /^(object|embed|param)$/, L;
        L = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, g, f, h, l;
                    a.name = c.element;
        ...
        return {
            load: function (b, c, e, m) {
                ...
                k && (b = [b]);
                e || (e = CKEDITOR);
                var d = b.length, h = [], l = [], g = function (a) {
        ...
        add: function (a, f) {
            ...
            for (var c = this.loaded, e = this.registered, m = [], k = {}, d = {}, h = 0; h < a.length; h++) {
                var l = a[h];
                if (l) if (c[l] || e[l]) d[l] = this.get(l);
                else {
        ...
        function u(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, g, f, h, l = 0; l < a.length; l++) {
                var m = a[l], k = m.startContainer.getAscendant("tr", !0);
                c(m) ? (g ||
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (m, k, d) {
            function h(a) {
                ...
                if (0 < q.length) for (var c = 0; c < q.length; c++) {
                    var d = q[c], e = d.name, g = CKEDITOR.dtd[e], f = r.name && CKEDITOR.dtd[r.name];
            ...
            var C = new CKEDITOR.htmlParser,
                ...
                q = [], x = [], r = w, A = "textarea" == w.name, t = "pre" == w.name;
            C.onTagOpen =
                function (d, e, g, m) {
                    ...
                    if (a(e)) q.push(e); else {
                        ...
                        if ("br" == d) x.push(e); else {
                            for (; !(m = (g = r.name) ? CKEDITOR.dtd[g] || (r._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || r.isUnknown || m[d]);) if (r.isOptionalClose) C.onTagClose(g); else if (d in b && g in b) g = r.children, (g = g[g.length - 1]) && "li" == g.name || n(g = new CKEDITOR.htmlParser.element("li"),
                                r), !e.returnPoint && (e.returnPoint = r), r = g; else if (d in CKEDITOR.dtd.$listItem && !u(d, g)) C.onTagOpen("li" == d ? "ul" : "dl", {}, 0, 1); else if (g in f && !u(d, g)) !e.returnPoint && (e.returnPoint = r), r = r.parent; else if (g in CKEDITOR.dtd.$inline && q.unshift(r), r.parent) n(r, r.parent, 1); else {
                                e.isOrphan = 1;
                                break
                            }
                            h(d);
            ...
            C.onText = function (a) {
                ...
                var b = r.name, g = b ? CKEDITOR.dtd[b] || (r._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
        ...
        function a(a,
            ...
            var l = {elements: {}}, D = "html" == d, J = CKEDITOR.tools.extend({}, t), n;
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, d, c = w(c, b), c = g(c, F), c = l(c), c = g(c, I), c = c.replace(J, "$1cke:$2"),
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                ...
                return e.fire("toHtml", {
                    ...
                    filter: f || e.filter, enterMode: h || e.enterMode, protectedWhitespaces: l
                }).dataValue
        ...
        var q = /(?:&nbsp;|\xa0)$/, x = "{cke_protected}", r = CKEDITOR.dtd,
            A = "caption colgroup col thead tfoot tbody".split(" "), t = CKEDITOR.tools.extend({}, r.$blockLimit,
                r.$block), y = {elements: {input: d, textarea: d}}, v = {
        ...
        var H = /<(a|area|img|input|source)\b([^>]*)>/gi,
            G = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, E = /^(href|src|name)$/i,
            I = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            F = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, K = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            J = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            D = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, Q = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    }(),
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var h, l;
                for (h in k) {
                    for (d = k[h]; ;) if (l = a.onAttributeName(b, h)) if (l != h) delete k[h], h = l; else break; else {
                        delete k[h];
                        break
                    }
                ...
                b && this.filter(b);
                var m = this.name, k = [], d = this.attributes, h, l;
                a.openTag(m, d);
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != f.mode && k && k[a]) {
                ...
                if (f.mode) {
                    var d = f.checkDirty(), k = f._.previousModeData, h, l = 0;
                    f.fire("beforeModeUnload");
                    f.editable(0);
                    f._.previousMode = f.mode;
                    f._.previousModeData = h = f.getData(1);
                    "source" == f.mode && k == h && (f.fire("lockSnapshot", {forceUpdate: !0}), l = 1);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in n) {
                                    var e, f = b.getRanges()[0], h = f.startPath(), l, k, q, c = 8 == c;
                                    CKEDITOR.env.ie &&
        ...
        w = function () {
            ...
            function b(c, d) {
                var e, g, f, h, l = [], k = d.range.startContainer;
                e = d.range.startPath();
                ...
                "br" != f || !e.data("cke-eol") || n && n != H - 1 || (r = (g = n ? l[n - 1].node : q.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != x || h || (x = n), h || (v = n), l.push({
                    ...
                    name: f,
                    allowed: h
                }), g = r = 0)) : l.push({isElement: 0, node: e, allowed: 1});
            ...
            function e(b, c) {
                var d = [], g = b.getChildren(), f = g.count(), h, l = 0, k = m[c], n = !b.is(m.$inline) || b.is("br");
            ...
            var m = CKEDITOR.dtd, n = {
                ...
                dl: 1,
                blockquote: 1
            }, q = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, x = CKEDITOR.tools.extend({},
                m.$inline);
            delete x.br;
            return function (n, D, r, p) {
                ...
                if (!p.checkReadOnly()) {
                    ...
                    if (!D.collapsed) {
                        var A = C.block || C.blockLimit, fa = D.getCommonAncestor();
                    ...
                    if (I) {
                        ...
                        var V, Y;
                        D = P.startContainer;
                        var w = n.endPath.elements[0], Z, C = w.getPosition(D),
                ...
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), g = d.endPath(),
                            f = e.contains(CKEDITOR.dtd.$list), h = g.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            ...
                            if (a.mergeList) {
                                var h = g.contains(CKEDITOR.dtd.$list), l = f.contains(CKEDITOR.dtd.$list);
                    ...
                    function a(c) {
                        ...
                        f.guard = function (a, f) {
                            ...
                            if (f && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if (!f && l && a.equals(l)) g = c.clone(), g.setStartAt(l, CKEDITOR.POSITION_AFTER_START), e.push(g);
                            else {
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var f = c(g, e.bookmark), h = f.clone(), l, k, m = f.getCommonAncestor();
        ...
        function a(a, b) {
            ...
            if ((c = !b && 1 === a.length) && !(c = a[0].collapsed)) {
                ...
                var g = e.endContainer.getAscendant({td: 1, th: 1}, !0);
        ...
        function e() {
            ...
            if (b) {
                ...
                if (!(d = !c) && (d = !c.isHidden())) {
                    d =
                        b;
                    var e = c.getRanges(), g = d.getRanges(),
                        ...
                        m = 1 === e.length && e[0].collapsed, g = a(e, !!CKEDITOR.env.webkit) && a(g);
        ...
        function h(a) {
            ...
            var c = a.startContainer, e = a.getPreviousNode(d, null, c), g = a.getNextNode(d, null, c);
        ...
        var w = "function" != typeof window.getSelection, q = 1, x = CKEDITOR.tools.repeat("​", 7),
            r = new RegExp(x + "( )?", "g"), A, t, y, v = CKEDITOR.dom.walker.invisible(1), z = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                var f = c.document, h = CKEDITOR.document, l = c.editable(), k = f.getBody(),
                    n = f.getDocumentElement(), q = l.isInline(), x, r;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, {
            ...
            _createFillingCharSequenceNode: l, FILLING_CHAR_SEQUENCE: x
        });
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                if (this.isLocked) {
                    if (b) var d = this.getSelectedElement(), e = this.getRanges(), g = this.isFake;
                    this.isLocked = 0;
                    this.reset();
                ...
                if (b.length) if (this.isLocked) {
                    ...
                    a:{
                        var D, q;
                        if (1 == b.length &&
                            !(q = b[0]).collapsed && (n = q.getEnclosedNode()) && n.type == CKEDITOR.NODE_ELEMENT && (q = q.clone(), q.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (D = q.getEnclosedNode()) && D.type == CKEDITOR.NODE_ELEMENT && (n = D), "false" == n.getAttribute("contenteditable"))) break a;
                        n = void 0
                    }
                        ...
                        if (w) {
                            ...
                            for (p = 0; p < b.length; p++) {
                                ...
                                try {
                                    ...
                                    if (0 <=
                                        y.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), r.setEnd(d.endContainer.$, d.endOffset); else throw y;
                                }
                                m.addRange(r)
                            }
                        }
        ...
        function b(c) {
            ...
            if (c.collapsed) d = x(this, d), c.insertNode(d), c.moveToPosition(d, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                var q = c.createBookmark(),
                    r = q.startNode, p = q.endNode, v = r, y;
                if (!k) {
                    var t = c.getCommonAncestor(), k = a(r, t), t = a(p, t);
                ...
                for (v.getPosition(p) == CKEDITOR.POSITION_FOLLOWING && (v = 0); v;) {
                    ...
                    if (v.equals(p)) v = null, k = !0; else {
                        ...
                        if (t && m && CKEDITOR.dtd.$block[A]) for (var u = v, z = e(u), B = void 0, H = z.length, da = 0,
                                                                       u = H && new CKEDITOR.dom.range(u.getDocument()); da < H; ++da) {
                            var B = z[da], G = CKEDITOR.filter.instances[B.data("cke-filter")];
                            if (G ? G.check(this) : 1) u.selectNodeContents(B), b.call(this, u)
                        }
                        z = A ? !n[A] || w ? 0 : t && !m ? 0 : f(v, p, h, K) : 1;
                        if (z) if (B = v.getParent(), z = h, H = g, da = l, !B || !(B.getDtd() || CKEDITOR.dtd.span)[H] && !da || z.parentRule && !z.parentRule(B)) k = !0; else {
                            if (y || A && CKEDITOR.dtd.$removeEmpty[A] && (v.getPosition(p) | K) != K || (y = c.clone(), y.setStartBefore(v)), A = v.type, A == CKEDITOR.NODE_TEXT || t || A == CKEDITOR.NODE_ELEMENT && !v.getChildCount()) {
                                for (var A =
                                    v, F; (k = !A.getNext(I)) && (F = A.getParent(), n[F.getName()]) && f(F, r, h, J);) A = F;
                                y.setEndAfter(A)
                            }
                        } else k = !0;
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                (l = g.elements[h]) && l != g.block && l != g.blockLimit; h++) if (this.checkElementRemovable(l)) {
                    var k;
        ...
        function u(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = t(this)[a.getName()],
                g = CKEDITOR.tools.isEmpty(d) &&
                    CKEDITOR.tools.isEmpty(c), f;
        ...
        var B = {
                ...
                audio: 1,
                video: 1
            }, G = /\s*(?:;\s*|$)/, E = /#\((.+?)\)/g, I = CKEDITOR.dom.walker.bookmark(0, 1),
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c) if ("_length" !=
                            h) if (d = a.getAttribute(h) || "", "style" == h ? v(c[h], d) : c[h] == d) {
                            if (!b) return !0
                        } else if (b) return !1;
                        if (b) return !0
                    } else return !0
        ...
        compare: function (a) {
            ...
            var m = this.elements, k = m.length;
            f && (b ? c += 1 : --k);
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            getUiColor: function () {
                ...
                return (this.setUiColor = function (a) {
                    this.uiColor = a;
                    var c = CKEDITOR.skin.chameleon, f = "", l = "";
            ...
            onLoad: function () {
                ...
                CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
                    labeledElement: function (b, c, d, e) {
                        ...
                        if (!(3 > arguments.length)) {
                            a.call(this, c);
                            var f = this, k = this._.inputId = CKEDITOR.tools.getNextId() + "_textarea", m = {};
                            c.validate && (this.validate = c.validate);
                            m.rows = c.rows || 5;
                            m.cols = c.cols || 20;
                            ...
                            CKEDITOR.ui.dialog.labeledElement.call(this,
                                b, c, d, function () {
                                    for (var a = [], d = [], g = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", m = 0; m < c.items.length; m++) {
                                        var x = c.items[m], r = void 0 !== x[2] ? x[2] : x[0],
                                            A = void 0 !== x[1] ? x[1] : x[0],
                                            t = CKEDITOR.tools.getNextId() + "_radio_input", y = t + "_label",
                                            t = CKEDITOR.tools.extend({}, c, {id: t, title: null, type: null}, !0),
                                            r = CKEDITOR.tools.extend({}, t, {title: r}, !0), v = {
                                                type: "radio",
        ...
        function l(a) {
            function b(c) {
                var k = a.getSize(), l = CKEDITOR.document.getWindow().getViewPaneSize(), m = c.data.$.screenX,
                    n = c.data.$.screenY, q = m - d.x, x = n - d.y;
                d = {x: m, y: n};
                e.x += q;
                e.y += x;
        ...
        function g(a) {
            function b(c) {
                var n = "rtl" == f.lang.dir, q = m.width, x = m.height,
                    r = q + (c.data.$.screenX - l.x) * (n ? -1 : 1) * (a._.moved ? 1 : 2),
                    v = x + (c.data.$.screenY - l.y) * (a._.moved ? 1 : 2), y = a._.element.getFirst(),
                    y = n && y.getComputedStyle("right"), A = a.getPosition();
        ...
        CKEDITOR.dialog = function (b, d) {
            ...
            function n(c) {
                if (B == CKEDITOR.dialog._.currentTop) {
                    ...
                    z = w = 0;
                    if (9 == d || d == CKEDITOR.SHIFT + 9) k(d == CKEDITOR.SHIFT + 9 ? -1 : 1), z = 1; else if (d == CKEDITOR.ALT + 121 && !B._.tabBarMode && 1 < B.getPageCount()) B._.tabBarMode = !0, B._.tabs[B._.currentTabId][0].focus(), B._.currentFocusIndex = -1, z = 1; else if (-1 != CKEDITOR.tools.indexOf(g,
            ...
            var r = CKEDITOR.dialog._.dialogDefinitions[d], v = CKEDITOR.tools.clone(q),
                y = b.config.dialog_buttonsOrder || "OS", A = b.lang.dir, p = {}, z, w;
            ...
            v = {position: CKEDITOR.env.ie6Compat ? "absolute" : "fixed", top: 0, visibility: "hidden"};
            v["rtl" == A ? "right" : "left"] = 0;
            this.parts.dialog.setStyles(v);
            CKEDITOR.event.call(this);
            this.definition = r = CKEDITOR.fire("dialogDefinition",
                {name: d, definition: r}, b).definition;
            ...
            var B = this, u = function (a) {
                var b = B._.contents, c = !1, d;
            ...
            destroy: function () {
                ...
                for (var c in b.contents) if (b.contents[c]) {
                    ...
                    if (e) {
                        ...
                        !g || f && !this._.editor.activeFilter.check(f) ? e[0].addClass("cke_dialog_tab_disabled") :
                ...
                var a = this.parts.dialog, b = this.getSize(), c = CKEDITOR.document.getWindow().getViewPaneSize(), d =
            ...
            setupContent: function () {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    c = CKEDITOR.dom.element.createFromHtml(['\x3ca class\x3d"cke_dialog_tab"',
                        0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style\x3d"display:none"' : "", ' id\x3d"', e, '"', d.gecko && !d.hc ? "" : ' href\x3d"javascript:void(0)"', ' tabIndex\x3d"-1" hidefocus\x3d"true" role\x3d"tab"\x3e', a.label, "\x3c/a\x3e"].join(""));
                    ...
                    a.accessKey &&
                    (E(this, this, "CTRL+" + a.accessKey, K, F), this._.accessKeyMap["CTRL+" + a.accessKey] = a.id)
                }
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, d, e, f, g) {
                    if (!(4 > arguments.length)) {
                        var h = (d.call ? d(b) : d) || "div", k = ["\x3c", h, " "], l = (e && e.call ? e(b) : e) || {},
                            m = (f && f.call ? f(b) : f) || {}, n = (g && g.call ? g.call(this, a, b) : g) || "",
                    ...
                    if (!(4 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this,
                            a, e || {type: "hbox"}, d, "table", {}, l, function () {
        ...
        init: function (a) {
            var f = 0, b = function (b, d, e, l) {
                if (l) {
                    ...
                    a.addCommand(e, new CKEDITOR.styleCommand(l, {contentForms: g}));
        ...
        var a = {
            exec: function (a) {
                ...
                if (e) {
                    ...
                    if (CKEDITOR.env.ie) {
                        var k = m[0].startNode, d = m[0].endNode, h;
                        if (k && "blockquote" == k.getParent().getName()) for (h = k; h = h.getNext();) if (h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary()) {
                            k.move(h, !0);
                            break
                        }
                        if (d && "blockquote" == d.getParent().getName()) for (h = d; h = h.getPrevious();) if (h.type == CKEDITOR.NODE_ELEMENT &&
                            h.isBlockBoundary()) {
                            d.move(h);
                            break
                        }
        ...
        ka.prototype = {
            show: function () {
                ...
                var b = this.element, c = b.findOne(".cke_notification_message"),
                    e = b.findOne(".cke_notification_progress"), m = a.type;
            ...
            hide: function () {
                ...
                if ("number" == typeof this.duration) f = this.duration; else if ("info" == this.type || "success" == this.type) f = "number" == typeof this.editor.config.notification_duration ? this.editor.config.notification_duration :
                    5E3;
        ...
        add: function (a) {
            ...
            var a =
                this.editor, f = a.config, b = new CKEDITOR.dom.element("div");
            ...
            var a =
                CKEDITOR.document.getWindow(), f = this.editor;
            ...
            var f = this.element, b = this.editor, c = b.ui.contentsElement.getClientRect(),
                e = b.ui.contentsElement.getDocumentPosition(), m, k, d = f.getClientRect(), h,
                l = this._notificationWidth,
                g = this._notificationMargin;
            h = CKEDITOR.document.getWindow();
            var n = h.getScrollPosition(), p = h.getViewPaneSize(), u = CKEDITOR.document.getBody(),
                C = u.getDocumentPosition(), w = CKEDITOR.tools.cssLength;
            ...
            m && m.isVisible() && k.bottom > c.top && k.bottom < c.bottom -
            d.height ? f.setStyles({
                position: "fixed",
                top: w(k.bottom)
            }) : 0 < c.top ? f.setStyles({
                position: "absolute",
                ...
                position: "fixed",
                top: 0
            }) : f.setStyles({position: "absolute", top: w(e.y + c.height - d.height)});
            var q = "fixed" == f.getStyle("position") ? c.left : "static" != u.getComputedStyle("position") ? e.x - C.x : e.x;
            c.width < l + g ? e.x + l + g > n.x + p.width ? a() : f.setStyle("left", w(q)) : e.x + l + g > n.x + p.width ? f.setStyle("left", w(q)) : e.x + c.width / 2 + l / 2 + g > n.x + p.width ? f.setStyle("left", w(q - e.x + n.x +
                p.width - l - g)) : 0 > c.left + c.width - l - g ? a() : 0 > c.left + c.width / 2 - l / 2 ? f.setStyle("left", w(q - e.x + n.x)) : f.setStyle("left", w(q + c.width / 2 - l / 2 - g / 2))
        }
        ...
        CKEDITOR.ui.button.prototype = {
            render: function (a, e) {
                ...
                var k = CKEDITOR.env, d = this._.id = CKEDITOR.tools.getNextId(), h = "", l = this.command, g, n, p;
                this._.editor = a;
                var u = {
        ...
        function a(a) {
            ...
            var l = a.config.removeButtons, l = l && l.split(","), g = a.config.toolbar;
        ...
        CKEDITOR.plugins.add("toolbar", {
            requires: "button", init: function (e) {
                var f,
                    k = function (a, b) {
                        var c, g = "rtl" == e.lang.dir, n = e.config.toolbarGroupCycling, p = g ? 37 : 39,
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function (a, b, c) {
            var d = f(this.editor), h = 0 === b, l = {name: a};
            if (c) {
        ...
        function f(b) {
            ...
            function m(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    ...
                    q.setAttributes({id: "cke_pastebin", "data-cke-temp": "1"});
            ...
            var B = CKEDITOR.plugins.clipboard, H = 0, G = 0, E = 0;
            (function () {
                b.on("key", t);
                b.on("contentDom", c);
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "notification,toolbar", init: function (a) {
                ...
                if (CKEDITOR.env.gecko) {
                    var l = ["image/png", "image/jpeg", "image/gif"], C;
                    a.on("paste", function (b) {
                        var c = b.data, d = c.dataTransfer;
                        if (!c.dataValue && "paste" == c.method && d && 1 == d.getFilesCount() && C != d.id && (d = d.getFile(0), -1 !=
                        CKEDITOR.tools.indexOf(l, d.type))) {
                ...
                a.on("paste", function (b) {
                    ...
                    if (!b.data.dataValue) {
                        var c =
                            b.data.dataTransfer, d = c.getData("text/html");
                ...
                a.on("paste", function (d) {
                    ...
                    var e = a._.nextPasteType || d.type, f = d.dataValue, h,
                        l = a.config.clipboard_defaultContentType ||
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function (a, b, c, d) {
                function e(a, c, d) {
                    ...
                    if (f.equals(c) && d != c.getChildCount()) return a = b.startContainer.getChild(b.startOffset -
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (k) {
                                ...
                                var z = b.document.$.elementFromPoint(d, e), B = new CKEDITOR.dom.element(z), H;
                                if (B.equals(b.editable()) || "html" == B.getName()) return f && f.startContainer && !f.startContainer.equals(b.editable()) ? f : null;
                                H = B.getClientRect();
                                d < H.left ? h.setStartAt(B,
                                    CKEDITOR.POSITION_AFTER_START) : h.setStartAt(B, CKEDITOR.POSITION_BEFORE_END);
                                h.collapse(!0)
                            }
                        } catch (G) {
                            return null
            ...
            getData: function (a, b) {
                ...
                if (this.$) {
                    ...
                    if (this.$ && this.$.files || d) {
                        this._.files = [];
                        if (this.$.files && this.$.files.length) for (c =
        ...
        CKEDITOR.ui.panel.prototype = {
            render: function (c,
                ...
                if (this.isFramed) {
                    ...
                    m.frame = f.output({id: this.id + "_frame", src: k})
                }
                k = a.output(m);
                e && e.push(k);
                return k
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (b, c, e, f) {
                ...
                var d = c.getDocument();
                f = a(b, d, c, e, f || 0);
                var h = f.element, l = h.getFirst(), g = this;
                ...
                showBlock: function (a, c, e, f, k, d) {
                    var h = this._.panel, l = h.showBlock(a);
                    ...
                    var n = this.element, g = this._.iframe,
                        ...
                        C = c.getDocumentPosition(p), p = u ? u.getDocumentPosition(p) :
                            {x: 0, y: 0}, w = "rtl" == this._.dir, q = C.x + (f || 0) - p.x, x = C.y + (k || 0) - p.y;
                    !w || 1 != e && 4 != e ? w || 2 != e && 3 != e || (q += c.$.offsetWidth - 1) : q += c.$.offsetWidth;
                    if (3 == e || 4 == e) x += c.$.offsetHeight - 1;
                    this._.panel._.offsetParentId = c.getId();
                    n.setStyles({top: x + "px", left: 0, display: ""});
                    n.setOpacity(0);
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            n.setStyles({top: x + "px", left: q + "px"});
                            n.setOpacity(1);
                            d && d()
                        }, this);
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                add: function (a) {
                    ...
                    var f = this.items, g = this.editor, n = this._.panel, p = this._.element;
                    if (!n) {
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, c) {
                ...
                render: function (a, f, d) {
                    var h = a.id + String(f), l = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state,
                        g = "", n = this.editor, p, u,
                    ...
                    var w = this.getItems, q = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";",
                        x = this.name;
                    ...
                    a = {
                        ...
                        shortcutHtml: u ? e.output({shortcut: u.display}) : "",
                        arrowHtml: w ? c.output({label: q}) : "",
        ...
        function a(a, b) {
            ...
            var h = a.ui.spaceId("path"), l, g = a._.elementsPath, n = g.idBase;
            ...
            g.onClick = k;
            var p = CKEDITOR.tools.addFunction(k), u = CKEDITOR.tools.addFunction(function (b, c) {
                var d = g.idBase, f;
        ...
        CKEDITOR.plugins.add("indent", {
            init: function (b) {
                ...
                b.on("dirChanged", function (a) {
                    ...
                    e.setStartBefore(d);
                    e.setEndAfter(d);
                    for (var f = new CKEDITOR.dom.walker(e), l; l = f.next();) if (l.type == CKEDITOR.NODE_ELEMENT) if (!l.equals(d) && l.getDirection()) e.setStartAfter(l),
        ...
        function a(a) {
            function c(f) {
                ...
                for (var A =
                    e.isIndent ? 1 : -1, r = h[0], h = h[h.length - 1], t = CKEDITOR.plugins.list.listToArray(f, g), y = t[h.getCustomData("listarray_index")].indent, r = r.getCustomData("listarray_index"); r <= h.getCustomData("listarray_index"); r++) if (t[r].indent += A, 0 < A) {
                    var v = t[r].parent;
        ...
        var c = CKEDITOR.dom.walker.whitespaces(!0), e = CKEDITOR.dom.walker.bookmark(!1, !0),
            m = CKEDITOR.TRISTATE_DISABLED, k = CKEDITOR.TRISTATE_OFF;
        ...
        function m(a, d, e) {
            ...
            var h = d.createBookmark(), l = new CKEDITOR.dom.elementPath(d.startContainer), m = l.block,
                l = l.lastElement.getAscendant("li", 1) || m, y = new CKEDITOR.dom.elementPath(e.startContainer),
                v = y.contains(CKEDITOR.dtd.$listItem), y = y.contains(CKEDITOR.dtd.$list);
        ...
        var d = {ol: 1, ul: 1}, h = CKEDITOR.dom.walker.whitespaces(), l = CKEDITOR.dom.walker.bookmark(),
            g = function (a) {
                return !(h(a) || l(a))
            ...
            listToArray: function (a, b, c, e, f) {
                ...
                for (var h, k = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(k), n = null, z = c, B = Math.max(a[c].indent, 0), p = null, u, E, I = e == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    ...
                    if (F.indent == B) {
                        ...
                        var n = h.getDirection(1) != u, K = F.element, J = K.getAttribute("class"),
                            D = K.getAttribute("style"),
                            Q = p.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (e != CKEDITOR.ENTER_BR || n || D || J), N,
                            R = F.contents.length, L;
        ...
        f.prototype = {
            exec: function (b) {
                ...
                for (var e = f.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0; (l = h.getNextRange()) && ++n;) {
                    var v = l.getBoundaryNodes(), z = v.startNode, B = v.endNode;
                    ...
                    for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; v =
                        l.getNextParagraph();) if (!v.getCustomData("list_block")) {
                ...
                for (G = []; 0 < k.length;) if (z = k.shift(), this.state == CKEDITOR.TRISTATE_OFF) if (d[z.root.getName()]) {
                    h = b;
                    n = z;
                    z = m;
                    l = G;
                    ...
                    for (var E = n.root.getDocument(),
                        ...
                        var K = u[v].getCustomData("listarray_index"), I = B[K].parent;
            ...
            requires: "indentlist", init: function (a) {
                a.blockless || (a.addCommand("numberedlist", new f("numberedlist", "ol")), a.addCommand("bulletedlist", new f("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
                    ...
                    if ("wysiwyg" == a.mode && c in {8: 1, 46: 1}) {
                        var h = a.getSelection().getRanges()[0], l = h && h.startPath();
                        if (h && h.collapsed) {
                            var t = 8 == c, y = a.editable(), v = new CKEDITOR.dom.walker(h.clone());
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function (a, d, m, p) {
                if (m = m || f(a)) {
                    m = b(m);
                    var u = m.document, C = m.checkStartOfBlock(), w = m.checkEndOfBlock(),
                        q = a.elementPath(m.startContainer),
                        x = q.block, r = d == CKEDITOR.ENTER_DIV ? "div" : "p", A;
                    if (C && w) {
                        if (x && (x.is("li") || x.getParent().is("li"))) {
                            ...
                            A = m.getParent();
                            p = !x.hasPrevious();
                            var t = !x.hasNext(), r = a.getSelection(), y = r.createBookmarks(), C = x.getDirection(1),
                                w = x.getAttribute("class"), v = x.getAttribute("style"), z = A.getDirection(1) != C;
                            a = a.enterMode != CKEDITOR.ENTER_BR || z || v || w;
                            if (A.is("li")) p || t ? (p && t && m.remove(), x[t ? "insertAfter" : "insertBefore"](A)) : x.breakParent(A); else {
                                if (a) if (q.block.is("li") ? (A =
                                    u.createElement(d == CKEDITOR.ENTER_P ? "p" : "div"), z && A.setAttribute("dir", C), v && A.setAttribute("style", v), w && A.setAttribute("class", w), x.moveChildren(A)) : A = q.block, p || t) A[p ? "insertBefore" : "insertAfter"](m); else x.breakParent(m), A.insertAfter(m); else if (x.appendBogus(!0), p || t) for (; u = x[p ? "getFirst" : "getLast"]();) u[p ? "insertBefore" : "insertAfter"](m); else for (x.breakParent(m); u = x.getLast();) u.insertAfter(m);
                                x.remove()
                            }
                            r.selectBookmarks(y);
                            return
                ...
                if (c = c || f(a)) {
                    var k = c.document, m = c.checkEndOfBlock(),
                        w = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), q = w.block,
                        x = q && w.block.getName();
        ...
        var m = CKEDITOR.plugins.enterkey, k = m.enterBr, d = m.enterBlock, h = /^h[1-6]$/
    }(),function () {
        function a(a, b) {
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function (f) {
                ...
                if (f = (f = f.dataProcessor) && f.htmlFilter) {
                    ...
                    var k = a(m.join(",")), d = k.regex ? "[" + k.regex + "]" : "a^";
                    delete k.regex;
                    e.entities && e.entities_processNumerical && (d = "[^ -~]|" + d);
                    var d = new RegExp(d, "g"), h = a("nbsp,gt,lt,amp,shy", !0), l = new RegExp(h.regex, "g");
                    f.addRules({
                        text: function (a) {
        ...
        function a(a) {
            var e = a.config, m = a.fire("uiSpace", {space: "top", html: ""}).html, k = function () {
                function d(a, c, e) {
                    h.setStyle(c, b(e));
                ...
                var m, l, w, q, x, r, A, t = e.floatSpaceDockedOffsetX || 0, y = e.floatSpaceDockedOffsetY || 0,
                    v = e.floatSpacePinnedOffsetX || 0, z = e.floatSpacePinnedOffsetY || 0;
                return function (d) {
                    if (l = a.editable()) {
            ...
            if (m) {
                var d = new CKEDITOR.template('\x3cdiv id\x3d"cke_{name}" class\x3d"cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' + CKEDITOR.env.cssClass + '" dir\x3d"{langDir}" title\x3d"' + (CKEDITOR.env.gecko ? " " : "") + '" lang\x3d"{langCode}" role\x3d"application" style\x3d"{style}"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : " ") + "\x3e" + (a.title ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' :
                    ...
                    h = CKEDITOR.document.getBody().append(CKEDITOR.dom.element.createFromHtml(d.output({
                        ...
                        voiceLabel: a.title
                    }))), l = CKEDITOR.tools.eventsBuffer(500, k), g = CKEDITOR.tools.eventsBuffer(100, k);
                h.unselectable();
                h.on("mousedown",
                    function (a) {
                        a = a.data;
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            $: function (a) {
                ...
                renderHtml: function (a) {
                    ...
                    var m = CKEDITOR.env, k = "cke_" + this.id, d = CKEDITOR.tools.addFunction(function (c) {
        ...
        requires: "richcombo", init: function (a) {
            if (!a.blockless) {
                for (var f =
                    ...
                    var h = c[d], l = new CKEDITOR.style(f["format_" + h]);
        ...
        CKEDITOR.editor.prototype.createFakeParserElement =
            function (a, c, d, e) {
                var l = this.lang.fakeobjects, l = l[d] || l.unknown, g;
        ...
        var e = /^javascript:/, m = /^mailto:([^?]+)(?:\?(.+))?$/, k = /subject=([^;?:@&=$,\/]*)/i,
            d = /body=([^;?:@&=$,\/]*)/i, h = /^#(.*)$/, l = /^((?:http|https|ftp|news):\/\/)?(.*)$/,
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (a, b) {
                ...
                var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    f = a.plugins.link.compiledProtectionFunction, t = a.config.emailProtection, y, v = {};
        ...
        function l(a, c) {
            return {
                canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
                    function d(b) {
                        var e = E.ie && 9 > E.version ? " " : ca, f = a.hotNode && a.hotNode.getText() ==
        ...
        function p(a) {
            if (!n(a)) return !1;
            var b;
            (b = u(a)) || (n(a) ? (b = {left: 1, right: 1, center: 1}, b = !(!b[a.getComputedStyle("float")] &&
        ...
        function r(a) {
            ...
            if (!h) return null;
            t(a, h);
            var g = Math.min(g, 0 | h.size.outerHeight / 2), k = [], l, v;
        ...
        function z(a, b, c, d) {
            for (var e = d, g = d, h = 0, k = !1, l = !1, m = a.view.pane.height, v = a.mouse; v.y + h < m && 0 < v.y - h;) {
                k || (k = b(e, d));
                l || (l = b(g, d));
                !k && 0 < v.y - h && (e = c(a, {x: v.x, y: v.y - h}));
                !l && v.y + h < m && (g = c(a, {x: v.x, y: v.y + h}));
                if (k && l) break;
                h += 2
            }
            ...
            init: function (a) {
                ...
                a.on("contentDom",
                    function () {
                        ...
                        B(m, {editable: k, inInlineMode: k.isInline(), doc: n, win: p, hotNode: null}, !0);
                        ...
                        k.is(F.$inline) || (m.inInlineMode && !u(k) && k.setStyles({
                            ...
                            m.hiddenMode = 0;
                            m.mouseDown = 0
                        }), a.addCommand("accessPreviousSpace", l(m)), a.addCommand("accessNextSpace", l(m, !0)), a.setKeystroke([[c.magicline_keystrokePrevious, "accessPreviousSpace"], [c.magicline_keystrokeNext, "accessNextSpace"]]),
        ...
        var B = CKEDITOR.tools.extend, H = CKEDITOR.dom.element, G = H.createFromHtml,
            E = CKEDITOR.env, I = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, F = CKEDITOR.dtd, K = {}, J = 128,
            D = 64, Q = 32, N = 16, R = 4, L = 2, U = 1, ca = " ", ba = F.$listItem, fa = F.$tableContent,
            O = B({}, F.$nonEditable, F.$empty), P = F.$block, M = 100,
        ...
        CKEDITOR.plugins.add("maximize", {
            init: function (a) {
                ...
                if (a.elementMode !=
                    ...
                    var d = a.lang, h = CKEDITOR.document, l = h.getWindow(), g, n, p, u = CKEDITOR.TRISTATE_OFF;
                    a.addCommand("maximize", {
                        ...
                        exec: function () {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                C.$.offsetLeft;
                                C.setStyles({"z-index": a.config.baseFloatZIndex - 5, left: "0px", top: "0px"});
                                C.addClass("cke_maximized");
                                f();
                                w = C.getDocumentPosition();
                                C.setStyles({left: -1 * w.x + "px", top: -1 * w.y + "px"});
                ...
                f.on("paste", function (e) {
                    ...
                    if (k && (b || h) && (!1 !== f.fire("pasteFromWord", d) || b)) {
                        ...
                        var l = a(f, c, function () {
                            if (l) f.fire("paste", m); else if (!f.config.pasteFromWordPromptCleanup || b || confirm(f.lang.pastefromword.confirmCleanup)) d.dataValue =
        ...
        var a = {
            canUndo: !1, async: !0, exec: function (a, b) {
                ...
                a.execCommand("paste", {type: "text", notification: m ? c : !1})
            }
        };
            ...
            removeformat: {
                exec: function (a) {
                    for (var f = a._.removeFormatRegex ||
                        ...
                        var h = d.createBookmark(), l = h.startNode, g = h.endNode, n = function (b) {
        ...
        CKEDITOR.plugins.add("resize", {
            init: function (a) {
                function f(b) {
                    var e = h.width, f = h.height, k = e + (b.data.$.screenX - d.x) * ("rtl" == m ? -1 : 1);
                ...
                function b() {
                    ...
                    a.document && (a.document.removeListener("mousemove", f), a.document.removeListener("mouseup",
                        b))
                }
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", onLoad: function (a) {
            ...
            var f = CKEDITOR.plugins.scayt,
                ...
                b = b && b.dataFilter, m = a.addRemoveFormatFilter, k = function (b) {
            ...
            var c = {}, e = {}, m = b ? "word" : "phrase", k = b ? "startGrammarCheck" : "startSpellCheck", d = a.scayt;
            ...
            var b = a.scayt, c = this.scaytMenuDefinition(a), e = {}, m = a.config.scayt_contextCommands.split("|"),
                k = f.getAttribute(b.getLangAttribute()) || b.getLang(), d, h, l;
            d = b.isScaytNode(f);
            h = b.isGraytNode(f);
            ...
            typeof c[g].verification || c[g].verification(a) || delete e[g], a.addCommand(g, {exec: c[g].exec}), a.addMenuItem(g, {
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[f] = CKEDITOR.tools.override(a[f], function (a) {
                return function (c) {
                    var e = c.editor.scayt, f = this.contents, k = c.contents, d = null;
            ...
            CKEDITOR.plugins.add("stylescombo", {
                requires: "richcombo", init: function (a) {
                    ...
                    a.ui.addRichCombo("Styles", {
                        ...
                        onOpen: function () {
                            var e = a.getSelection().getSelectedElement() || a.editable(), e = a.elementPath(e),
                                d = [0, 0, 0, 0];
                            this.showAll();
                            this.unmarkAll();
                            for (var f in c) {
                    ...
                    if (b.editable().hasFocus) {
                        ...
                        if (d = (new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root)).contains({
                            ...
                            if (f || a) if (f) f = new CKEDITOR.dom.element(f), c.moveToElementEditStart(f), c.checkStartOfBlock() && c.checkEndOfBlock() || c.selectNodeContents(f); else return !0; else {
                                for (var l = d.getAscendant("table").$, f = d.getParent().$.cells, l = new CKEDITOR.dom.element(l.insertRow(-1),
        ...
        var b = void 0 === f ? this.getTabIndex() : f, c, e, m, k, d, h;
        if (0 >=
        ...
        function a(a, b) {
            ...
            function d(a) {
                0 < e.length || a.type != CKEDITOR.NODE_ELEMENT || !C.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(f, a, "selected_cell",
                    !0), e.push(a))
            }
            ...
            if (c instanceof CKEDITOR.dom.selection) {
                ...
                for (c = h; c <= k; c++) {
                    for (var l = g[c], m = new CKEDITOR.dom.element(f.$.rows[c]), n = 0; n < l.length; n++) {
                        var p = new CKEDITOR.dom.element(l[n]), u = p.getParent().$.rowIndex;
        ...
        function k(b) {
            ...
            var d = b.getRanges(), e = a(b), f = e[0], g = e[e.length - 1], e = f.getAscendant("table"),
                h = CKEDITOR.tools.buildTableMap(e), k, l, m = [];
            b.reset();
            var n = 0;
            for (b = h.length; n < b; n++) for (var p = 0, u = h[n].length; p < u; p++) void 0 === k && h[n][p] == f.$ && (k = p), h[n][p] == g.$ && (l = p);
            for (n = k; n <= l; n++) for (p = 0; p < h.length; p++) g = h[p], f = new CKEDITOR.dom.element(e.$.rows[p]), g = new CKEDITOR.dom.element(g[n]), g.$ && (1 == g.$.colSpan ? g.remove() : --g.$.colSpan,
        ...
        function h(b) {
            if (b instanceof CKEDITOR.dom.selection) {
                var c =
                    b.getRanges(), d = a(b), e = d[0] && d[0].getAscendant("table"), f;
                a:{
                    var g = 0;
                    f = d.length - 1;
        ...
        function n(b, c, d) {
            ...
            c = b.getDocument();
            var K = n, w = u = 0, J = !d && new CKEDITOR.dom.documentFragment(c), D = 0;
            for (c = 0; c < e.length; c++) {
                h = e[c];
                var Q = h.getParent(), N = h.getFirst(), R = h.$.colSpan, L = h.$.rowSpan, Q = Q.$.rowIndex,
                    U = g(k, Q, h), D = D + R * L, w = Math.max(w, U - p + R);
                u = Math.max(u, Q - n + L);
                d || (R = h, (L = R.getBogus()) && L.remove(),
                    R.trim(), h.getChildren().count() && (Q == K || !N || N.isBlockBoundary && N.isBlockBoundary({br: 1}) || (K = J.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !K || K.is && K.is("br") || J.append("br")), h.moveChildren(J)), c ? h.remove() : h.setHtml(""));
                K = Q
            }
            if (d) return u * w == D;
            J.moveChildren(b);
        ...
        function p(b, c) {
            ...
            if (c) return !0;
            var d = d[0], e = d.getParent(), f = e.getAscendant("table"), h = CKEDITOR.tools.buildTableMap(f),
                k = e.$.rowIndex, l = g(h, k, d), m = d.$.rowSpan, n;
            if (1 < m) {
                n = Math.ceil(m / 2);
                ...
                p || f.append(e)
            } else for (m = n = 1, f = e.clone(), f.insertAfter(e), f.append(e = d.clone()),
        ...
        function u(b, c) {
            ...
            var d = d[0], e = d.getParent(), f = e.getAscendant("table"), f = CKEDITOR.tools.buildTableMap(f),
                h = g(f, e.$.rowIndex, d), k = d.$.colSpan;
        ...
        var C = /^(?:td|th)$/, w = CKEDITOR.tools.isArray;
        CKEDITOR.plugins.tabletools = {
            requires: "table,dialog,contextmenu", init: function (c) {
                ...
                var w = c.lang.table, t = CKEDITOR.tools.style.parse;
                ...
                c.addMenuItems && c.addMenuItems({
                    tablecell: {
                        label: w.cell.menu, group: "tablecell", order: 1, getItems: function () {
                            ...
                            return {
                                ...
                                tablecell_properties: 0 < d.length ? CKEDITOR.TRISTATE_OFF :
                    ...
                    tablecell_merge_right: {
                        label: w.cell.mergeRight, group: "tablecell", command: "cellMergeRight",
                        order: 17
                    },
                    ...
                    tablerow: {
                        label: w.row.menu, group: "tablerow", order: 1, getItems: function () {
                            return {
                    ...
                    tablecolumn: {
                        label: w.column.menu, group: "tablecolumn", order: 1, getItems: function () {
                            return {
            ...
            }, getCellColIndex: c, insertRow: f, insertColumn: m, getSelectedCells: a
        };
        ...
        function a(a, b) {
            var c = a.getAscendant("table"), d = b.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c), f = h(a),
                g = h(b), k = [], l = {}, m, n;
            c.contains(d) && (b = b.getAscendant({td: 1, th: 1}), g = h(b));
            f > g && (c = f, f = g, g = c, c = a, a = b, b = c);
            for (c = 0; c < e[f].length; c++) if (a.$ ===
                e[f][c]) {
                m = c;
                break
            }
        ...
        function c(a, b) {
            ...
            a.fire("unlockSnapshot");
            b && (w = {active: !1}, a.getSelection().isInTable() && a.getSelection().reset())
        }
        ...
        function l(a) {
            ...
            if (a.data.getTarget().getName) {
                var g = a.editor || a.listenerData.editor, h = g.getSelection(1), n = b(g), p = a.data.getTarget(),
                    q = p && p.getAscendant({td: 1, th: 1}, !0), p = p && p.getAscendant("table", !0),
                    u = {table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1};
                f(a, h, n, p) && c(g, !0);
                !w.active && "mousedown" === a.name && CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT && p && (w = {active: !0}, CKEDITOR.document.on("mouseup", l, null, {editor: g}));
                (q || p) && k(g, q || p, a);
                "mouseup" === a.name && (CKEDITOR.tools.getMouseButton(a) ===
                CKEDITOR.MOUSE_BUTTON_LEFT && (e(a.data.getTarget()) || d(n, p)) && m(g), w = {active: !1}, CKEDITOR.document.removeListener("mouseup", l))
            }
        }
        ...
        u.prototype.getTableMap = function () {
            var a =
                r(this.cells.first, !0), b;
            a:{
                b = this.cells.last;
                var c = b.getAscendant("table"), d = h(b), c = CKEDITOR.tools.buildTableMap(c), e;
        ...
        var y = {
            onPaste: function (b) {
                ...
                var g = b.editor, h = g.getSelection(), k = x(h), l = this.findTableInPastedContent(g,
                    b.data.dataValue), m = h.isInTable(!0) && this.isBoundarySelection(h), n, p;
                ...
                var d, e = r(a.cells.first, !0), f = a._getTable(), g = {}, h, k, l, m;
                for (l = 0; l < c.length; l++) for (h = new CKEDITOR.dom.element(f.$.rows[a.rows.first.$.rowIndex + l]), m = 0; m < c[l].length; m++) if (k = new CKEDITOR.dom.element(c[l][m]), d = b[l] &&
        ...
        CKEDITOR.plugins.add("undo", {
            init: function (c) {
                ...
                var g = c.undoManager = new b(c), k = g.editingHandler =
                    new m(g), p = c.addCommand("undo", {
                    exec: function () {
        ...
        m.prototype = {
            onKeydown: function (d) {
                var e = d.data.getKey();
                if (229 !== e) if (-1 < CKEDITOR.tools.indexOf(a,
        ...
        function a(a) {
            ...
            var c = this.editor, d = a.document, h = d.body, l = d.getElementById("cke_actscrpt");
            ...
            $: function () {
                ...
                setData: function (a, c) {
                    ...
                    if (c) this.setHtml(a), this.fixInitialSelection(), f.fire("dataReady"); else {
                        ...
                        f._.dataStore = {id: 1};
                        var d = f.config, h = d.fullPage, l = d.docType,
                    ...
                    var b = a.config, c = b.fullPage, d = c && a.docType, f = c && a.xmlDeclaration,
                        l = this.getDocument(), c = c ? l.getDocumentElement().getOuterHtml() : l.getBody().getHtml();
